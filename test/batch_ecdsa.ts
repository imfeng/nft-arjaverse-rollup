...
describe('ECDSABatchVerifyNoPubkeyCheck', function () {
  ...
  var privkeys: Array<bigint> = [
    63156019995519918403007903688900322904670886112219928465604528207404551849998n,
  ...
  for (var idx = 0; idx < privkeys.length; idx++) {
    ...
    var msghash_bigint: bigint = BigInt("0xa2b260d6ba0b37a1b36b085b6a1544d67eba9f9bd25d9c2445e7ab3f2c9ce6f3");
